...
void loadConfiguration() {
    ...
    GlobalParams::simulation_time = readParam<unsigned long long>(config, "simulation_time");
    GlobalParams::n_virtual_channels = readParam<int>(config, "n_virtual_channels");
    GlobalParams::reset_time = readParam<unsigned long long>(config, "reset_time");
